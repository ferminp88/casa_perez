      ...
      {showDots ? (
        <div className="mt-8 flex items-center justify-center gap-5">
          ...
          <button
            ...
            className="grid h-12 w-12 place-items-center rounded-full border border-bone/15 bg-bone/5 text-bone backdrop-blur transition-all hover:border-magenta/60 hover:bg-magenta/10 hover:text-magenta active:scale-95"
          >
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      on ? "w-6 bg-magenta" : "w-1.5 bg-bone/25 hover:bg-bone/50",
                    )}
